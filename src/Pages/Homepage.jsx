...
// AIzaSyCDLUQets3HhmkIn-CtbxiH1zlAffNoEFQ

// https://drive.google.com/file/d/1vAb7Aqk1mbXjXeYFDK_8xK45epMubh0g/view?usp=sharing

const Homepage = () => {
//   const [data, setData] = useState([]);

//   useEffect(() => {
//     const fileId = '1vAb7Aqk1mbXjXeYFDK_8xK45epMubh0g';
// const apiKey = 'AIzaSyCDLUQets3HhmkIn-CtbxiH1zlAffNoEFQ';
  ...
  return (
    <>
      ...
      <div className='mx-auto text-center flex flex-col justify-center text-white px-8'>
        <h1 className="md:text-6xl text-5xl font-bold md:py-6 pb-12">Our Projects</h1>
       
      </div>
      <div className="mx-24 grid md:grid-cols-3 gap-8 ">
        {projCards.slice(0, cardsToShow).map((project)=>(
               <CreateProjCard image={project.image}
               title={project.title} key={project.id} id={project.id}/>
          ))}   
        </div>
      ...
      <h2 className="md:text-6xl sm:text-5xl text-4xl font-bold md:py-6 text-white my-8 ">Testimonials</h2>
      <TestimonialCarousel />
    </div>
    </div>
